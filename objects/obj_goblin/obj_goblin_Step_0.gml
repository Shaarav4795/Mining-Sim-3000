...
if (!place_meeting(x + dx, y, obj_dirt_block)) x += dx; else move_dir += irandom_range(90, 180);
if (!place_meeting(x, y + dy, obj_dirt_block)) y += dy; else move_dir += irandom_range(90, 180);
